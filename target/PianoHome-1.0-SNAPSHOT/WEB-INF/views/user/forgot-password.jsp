...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>Quên mật khẩu &ndash; Piano Home</title>
                ...
                <div id="page-content" style="padding-top: 70px;">
                    ...
                    <div class="page section-header text-center">
                        <div class="page-title">
                            <div class="wrapper"><h1 class="page-width">QUÊN MẬT KHẨU</h1></div>
                        </div>
                    </div>
                    <!--End Page Title-->
                    ...
                    <div class="container">
                        <div class="row" style="justify-content: initial;">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                                <div class="mb-4">
                                    <form method="POST" action="forgot-password" id="CustomerLoginForm" accept-charset="UTF-8" class="contact-form">	
                                        <div class="row">
                                            ...
                                            <div class="col-8 col-sm-8 col-md-8 col-lg-8">
                                                <div class="form-group text-center">
                                                    <label style="color: #df1a0b;">${error}</label>
                                                <label id="err" style="color: #df1a0b;"></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
